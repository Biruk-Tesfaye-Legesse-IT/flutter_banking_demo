// // import 'package:final_demo/application/bloc/TransactionBloc/login_bloc.dart';
...
//         if (transactionState is WithdrawSuccess) {
//           String message = transactionState.message;

//           // SnackBar(content: content)
//           final snackBar = SnackBar(content: Text(message));
//           ScaffoldMessenger.of(context).showSnackBar(snackBar);
//         //   Navigator.of(context)
//         //       .pushNamed(RouteGenerator.TransferPageRoute, arguments: message);
//         // }

//         if (transactionState is WithdrawFailure) {
...
//         transactionBloc.add(WithdrawButtonPressed(
